...
Below is a table with a randomly sampled country in our dataset.

```{r}

smallNumObs = env_data[which(env_data$Country %in% 
                               sample(unique(env_data$Country), 1, replace = FALSE)),]
table1(~year + AverageTemperature  |City, data = smallNumObs)
```
